...
const ViewBook = () => {
  ...
  const fetchReviews = async () => {
    try {
      const response = await axios.get(`${base_url}/reviews?book_id=${id}`,{
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`
        }
      });
  ...
  const handleSaveChanges =  async() => {
    ...
    try {
        ...
        await axios.put(`${base_url}/books/${book._id}`, formData,{
            headers: {
              Authorization: `Bearer ${localStorage.getItem('token')}`
            }
  ...
  const handleUpdateReview =  async() => {
    ...
    try {
        ...
        const response = await axios.put(`${base_url}/reviews/`, formData,{
            headers: {
              Authorization: `Bearer ${localStorage.getItem('token')}`
            }
        })
